<?php
    ...
    if(isset($_POST['modifierA'])){
        ...
        $m = $conn->prepare("UPDATE annonce SET Titre=?,Adresse=?,Type=?,Prix=?,N_colocation_possible=?,N_chambre=?,Surface=?,Logement_meublé=?,Université=?,Description_logement=? WHERE Id_annonce=? ");
