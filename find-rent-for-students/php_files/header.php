    ...
    <body>
        ...
        <header class="head">
            <div class="logo">
                ...
                <a href="accueil.php"><b><h5>ACCUEIL</h5></b><h3>Etudiant Internationaux</h3></a>
            </div>
            <nav>
                <ul class="headLinks">
                    <li class="li1 li1122"><a href="accueil.php">Accueil</a></li>
                    <li class="li1 li1122"><a href="pagesMesAnnonces.php">Offres de Logements</a></li>
                    <li class="li1 li1122"><a href="accueil.php">Discussion</a></li>
                    <li class="li1 li1122"><a href="about.php">Astuces</a></li>
                    <li class="li1 li1122"><a href="about.php">Calendrier & Evènements</a></li>
                    <?php
